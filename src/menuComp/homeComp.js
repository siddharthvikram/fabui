...
export function HomeComp({show}) {
    return(
        <div className="homeMainDiv">
          <div className="homefabUILogo">
          <svg className="uiLogo" viewBox="0 0 507.52 507.52">
             <g>
               <g>
                 <g>
         ...
         <h1>Build you Fabulous websites with fabUI</h1>
         <Button classes="btn getStartBtn">Get Started</Button>
         <Button classes="btn docuBtn">Documentation</Button>
        </div> 
      )
    }
